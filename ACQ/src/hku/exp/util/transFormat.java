...
public class transFormat {
    ...
    public static void main(String[] args) {
        ...
        try {
            outputStream = new FileOutputStream("../../data/"+ds+"/"+ds+"-mapper.txt");
        ...
        try {
            ...
            outputStream = new FileOutputStream("../../data/"+ds+"/"+ds+"-graph.txt");
        ...
        try {
            ...
            outputStream = new FileOutputStream("../../data/"+ds+"/"+ds+"-node.txt");
        ...
        try {
            ...
            outputStream = new FileOutputStream("../../data/"+ds+"/"+ds+"-ground.txt");
